...
class Shopping {
	...
	public static function deleteOrder(string $orderId) {
		$response = \CJ\CJClient::createRequest($endpoint="shopping/order/deleteOrder", $method="GET", $payload=["orderId"=>$orderId]);
		return $response;
	}
	
	public static function confirmOrder(string $orderId) {
		$response = \CJ\CJClient::createRequest($endpoint="shopping/order/confirmOrder", $method="GET", $payload=["orderId"=>$orderId]);
		return $response;
	}
